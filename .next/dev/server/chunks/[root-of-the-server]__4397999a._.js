...
const chatRequestSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    question: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().min(1).max(2000),
    ...
    language: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
        "en",
        "fr",
        "ar",
        "darija"
...
"[project]/lib/searchGate.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "shouldSearchLawDb",
    ()=>shouldSearchLawDb,
    "shouldSearchLawDbDynamic",
    ()=>shouldSearchLawDbDynamic
]);
...
const shouldSearchLawDb = (message)=>{
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$searchGate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/searchGate.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$deepseek$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/deepseek.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/prisma.ts [app-route] (ecmascript)");
...
const POST = async (request)=>{
    ...
    const needsSearch = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$searchGate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["shouldSearchLawDbDynamic"])(question);
    ...
    const userLang = requestedLanguage || detectLang(question);
    /*if (!needsSearch) {
    let answer = "";
  ...
  */ if (!needsSearch) {
        ...
        try {
            ...
            const dsResp = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$deepseek$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateDeepSeekResponse"])([
                {
                    role: "system",
                    content: system
                },
            ...
            const langKey = userLang in localReplies ? userLang : "en";
        ...
        try {
            const userAgent = hdrs.get("user-agent") || undefined;
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].chatQuery.create({
                data: {
                    question,
                    answer,
                    grounded: false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4397999a._.js.map